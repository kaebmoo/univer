...
เพื่อให้เห็นภาพชัดเจนว่าต้องดึงค่าอะไรมาชนกับอะไร ผมสรุปเป็นตารางให้ดังนี้ครับ:
...
เมื่อเข้าใจหลักการแล้ว ในขั้นตอนถัดไปที่คุณจะเขียน Code (หรือให้ผมเขียนให้) คุณจะต้องเตรียม Logic ในการจัดการข้อมูลดังนี้:
